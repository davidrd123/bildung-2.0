...
| **Uexküll** | world-relative meaning, organism/world coupling, no neutral view from nowhere | `sources/german/uexkuell-theoretische-biologie/README.md`, its encounter dossiers / glossary / journal, and the rotating-hierarchy note in `higher-purpose-distillation.md` | represent perspective, subject-cut objects, and overlapping world-coupling, not just content blobs |
| **Anders** | apparatus-world, `Vorentscheidung`, `prometheisches Gefälle`, `Massenmensch`, worldlessness, `Apokalypseblindheit` | `sources/german/anders-antiquiertheit-des-menschen-band1/README.md`, its encounter dossiers / glossary / journal, and the Anders sections in `00-Notes/cross-domain-synthesis-threads.md` | represent worlds that are technically pre-cut before explicit choice, and track mismatches between making, imagining, feeling, and responsibility |
