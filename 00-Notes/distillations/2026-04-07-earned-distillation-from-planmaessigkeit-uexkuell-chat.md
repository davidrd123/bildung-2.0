...
- `00-Notes/distillations/2026-04-07-earned-distillation-from-warburg-chat-on-method-pressure.md`
- `00-Notes/distillations/2026-04-07-earned-distillation-from-source-role-taxonomy-chat-and-deepresearch.md`
- `00-Notes/DeepResearch/2026-04-07/archive/distillation-codex-audit.md`

Current support:

- strong support that translation resistance is already a real working method in the project, not a proposal
- strong support that source-language secondary commentary is a distinct and underused evidence type
- moderate support for small operational moves (resistance-reveal notes, German-as-annotation, morphological bridging as bounded experiment)
- weak support for any framework import (KR, category theory, conceptual blending, sheaf theory) from this chat alone
...
This does not need a new canonical status or schema. It needs continued attention in existing practice — particularly in the close-reading ledger and glossary notes.

### 2. Source-language secondary commentary is a distinct and underused evidence type
...
- Leibniz's characteristica universalis as a regulative ideal for the project
...
- The broader `what happened to the humanities` and `did monolingualism cause the analytic/continental split` discussions — interesting, not evidence for anything the project should act on

## Use rule

Use this note when:

- deciding how much of the Planmäßigkeit chat is actually method-relevant vs. exploratory weaving
- checking whether a translation-resistance observation belongs in the close-reading ledger, the glossary, or only in the journal
- preparing a return to Uexküll or any source where morphological binding carries the argument
- choosing between an English-only synthesis note and one that keeps source terms live
