...
| `freedman-compression-modeling-mathematics.md` | Compression, wrapped/unwrapped length, macro-set problem, PageRank-style mathematical interest | open (Abstract, Introduction, MathLib analysis, and Outlook read; useful for load-bearing-handle diagnostics; stronger algebraic transfers explicitly held open) |
