#!/usr/bin/env python3
"""Create plain-text search surfaces from Perseus TEI Plato files."""
...
def write_sections(
    ...
    for child in child_textpart_divs(element):
