...
- the first fifty-five real batches now exist in `sections/01-history-and-ruin.md`, `sections/02-judgment-and-civilization.md`, `sections/03-history-and-the-dying-century.md`, `sections/04-christianity-and-servility.md`, `sections/05-culture-and-concrete-value.md`, `sections/06-historiography-and-tragic-man.md`, `sections/07-order-and-its-ruins.md`, `sections/08-mythology-and-technique.md`, `sections/09-scale-luck-and-authority.md`, `sections/10-sacred-remnant.md`, `sections/11-poterna-and-pretension.md`, `sections/12-soul-forgiveness-authority.md`, `sections/13-love-method-and-homage.md`, `sections/14-grace-and-the-legitimate.md`, `sections/15-belief-style-and-homage.md`, `sections/16-tragedy-mystery-and-order.md`, `sections/17-authenticity-and-mystery.md`, `sections/18-revelation-and-the-significant-word.md`, `sections/19-judgment-and-two-faiths.md`, `sections/20-beauty-and-vertical-order.md`, `sections/21-hyperchronism-and-fealty.md`, `sections/22-trivialization-and-place.md`, `sections/23-vigency-and-partiality.md`, `sections/24-providence-and-tension.md`, `sections/25-resurrection-and-form.md`, `sections/26-autonomy-and-remedy.md`, `sections/27-history-and-conversion.md`, `sections/28-mystery-and-diagnosis.md`, `sections/29-history-and-failure.md`, `sections/30-justice-and-aggiornamento.md`, `sections/31-structures-and-evangelisms.md`, `sections/32-imagination-and-survival.md`, `sections/33-values-and-colonization.md`, `sections/34-inheritance-and-prison.md`, `sections/35-scandal-and-admiration.md`, `sections/36-politics-and-vacuity.md`, `sections/37-reaction-and-complicity.md`, `sections/38-christendom-and-paradox.md`, `sections/39-hope-and-gratuity.md`, `sections/40-progress-and-ugliness.md`, `sections/41-history-and-subordination.md`, `sections/42-posterity-and-sedition.md`, `sections/43-eschatology-and-sufficiency.md`, `sections/44-faith-and-imagination.md`, `sections/45-naturalness-and-judgment.md`, `sections/46-state-and-continuity.md`, `sections/47-geometry-and-postration.md`, `sections/48-posterities-and-readings.md`, `sections/49-mediocrity-and-exposure.md`, `sections/50-faith-and-prohibition.md`, `sections/51-noble-conflict-and-humanism.md`, `sections/52-reticence-and-adult-intelligence.md`, `sections/53-counterrevolution-and-loyalty.md`, `sections/54-historicity-and-judgment.md`, and `sections/55-taste-and-demythologization.md`
