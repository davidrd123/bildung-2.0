...
- `[4:1]` Dick begins by using *Ubik* as his first conceptual map rather than turning to an external philosophical source
- `[4:41]` he explicitly worries that life is behaving like his own novels and that authorship itself may be inverted
- `[4:135]` Malcolm Edwards' reading of *Ubik* helps Dick treat the novels as an a priori map of reality
- `[24:15]` the prison-world and false-self motifs are declared the lifelong twin themes of his corpus, verified by 3-74
- `[25:21]` *Ubik*, *Flow My Tears*, and *Stigmata* are reread as specific prior approaches to Zebra, prison reality, and the contending powers
- `[25:24]` Dick dates the convergence more precisely: only by *Ubik* did he begin to intuit Zebra, and only by *Tears* did he see the prison clearly
- `[27:3]` rereading Lem on *Ubik* helps Dick connect his unusual relation to causality with what the novel had already been trying to say
- `[27:77]` the entire arc from "Roog" to *A Scanner Darkly* becomes the long-form question to which 3-74 finally supplies the answer
- `[28:1]` *Ubik* is explicitly identified as a fictional account of Logos-information breaking into an irreal world
- `[28:33]` "Ubik wrote Ubik" becomes the strongest direct claim that the novel is scripture-like revelation
- `[28:45]` the whole writing career is recast as apprenticeship preparing Dick to undergo and understand 2-3-74
