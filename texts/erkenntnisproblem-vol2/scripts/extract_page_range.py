#!/usr/bin/env python3
"""Extract a PDF page range from Cassirer's volume 2 into plain text."""
...
PROJECT_ROOT = REPO_ROOT / "texts" / "erkenntnisproblem-vol2"
DEFAULT_PDF = PROJECT_ROOT / "source" / "pdf" / "daserkenntnispro02cassuoft.pdf"
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        default="raw",
        help="`pdftotext` extraction mode; `raw` is the default initial mode for this scan",
    )
